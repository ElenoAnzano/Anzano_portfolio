...
export default function AboutHero() {
    return (
        ...
        <div className="flex flex-col items-center justify-center p-10">
            ...
            <p className="text-xl text-gray-1000 font-bold mb-5">Eleno Anzano Jr</p>
            <h2 className="text-4xl text-gray-1000 font-bold mb-4">About</h2>
            <p className="text-lg text-center text-gray-800 w-200">
                ...
                <h2 className="text-2xl text-gray-1000 font-bold p-2">Experience</h2>
                <Experience />     
        </div>
    );
}